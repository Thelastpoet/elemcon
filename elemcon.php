...
function register_navbar_widget( $widgets_manager ) {
    require_once( __DIR__ . '/widgets/navbar-container.php' );
...
function enqueue_widget_scripts() {
    wp_enqueue_script( 'navbar-widget-script', plugins_url( 'assets/js/navbar-widget.js', __FILE__ ), array( 'elementor-editor' ), '1.0.0', true );
}
